...
const IMAGES = {
  avocadoToast: '/images/food_avocadotoast_1775236115050.png',
  brownie: '/images/food_brownie_1775236260195.png',
  coffee: '/images/food_coffee_1775236280008.png',
  focaccia: '/images/food_focaccia_1775236295923.png',
  pasta: '/images/food_pasta_1775236139751.png',
  // For items without local images, use unique Unsplash URLs
  cheesecake: 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?auto=format&fit=crop&q=80&w=1024',
  medialunas: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&q=80&w=1024',
  alfajores: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&q=80&w=1024',
  cappuccino: 'https://images.unsplash.com/photo-1510591509098-f4fdc6d0ff04?auto=format&fit=crop&q=80&w=1024',
  matcha: 'https://images.unsplash.com/photo-1536256263959-770b48d82b0a?auto=format&fit=crop&q=80&w=1024',
  lasagna: 'https://images.unsplash.com/photo-1574894709920-11b28e7367e3?auto=format&fit=crop&q=80&w=1024',
  gnocchi: 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?auto=format&fit=crop&q=80&w=1024',
  tortellini: 'https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=1024',
  mezzelune: 'https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=1024',
  cappelletti: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&q=80&w=1024',
  ravioliCalabaza: 'https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?auto=format&fit=crop&q=80&w=1024',
  sorrentinos: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&q=80&w=1024',
  spaghetti: 'https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?auto=format&fit=crop&q=80&w=1024',
  tallarines: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&q=80&w=1024',
  canelonesVerdura: 'https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?auto=format&fit=crop&q=80&w=1024',
  carrotCake: 'https://images.unsplash.com/photo-1621303837174-89787a7d4729?auto=format&fit=crop&q=80&w=1024',
  lemonPie: 'https://images.unsplash.com/photo-1519915028121-7d3463d20b13?auto=format&fit=crop&q=80&w=1024',
  brioche: 'https://images.unsplash.com/photo-1587668178277-295251f900ce?auto=format&fit=crop&q=80&w=1024',
  sourdough: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?auto=format&fit=crop&q=80&w=1024',
  milkBread: 'https://images.unsplash.com/photo-1598373182307-6141dc76f1a0?auto=format&fit=crop&q=80&w=1024',
  ravioli: 'https://images.unsplash.com/photo-1551468747-ed2c8a8cf8cb?auto=format&fit=crop&q=80&w=1024',
  cannelloni: 'https://images.unsplash.com/photo-1621996346565-e3dbc353d2e5?auto=format&fit=crop&q=80&w=1024',
  coldBrew: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?auto=format&fit=crop&q=80&w=1024',
  orangeJuice: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?auto=format&fit=crop&q=80&w=1024',
};
...
export const breakfastItems = [
  // Combos
  {
    ...
    price: "$18.500",
    category: "Combos",
    image: 'https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?auto=format&fit=crop&q=80&w=1024',
  ...
  },
  {
    ...
    price: "$21.000",
    category: "Combos",
    image: 'https://images.unsplash.com/photo-1551024506-0bccd828d307?auto=format&fit=crop&q=80&w=1024',
    tags: ["Para 2", "Dulce"],
  },
  {
    id: "b3",
    ...
    price: "$22.500",
    category: "Combos",
    image: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&q=80&w=1024',
  ...
  // Salados
  {
    ...
    price: "$8.500",
    category: "Salados",
    image: 'https://images.unsplash.com/photo-1541519227354-08fa5d50c44d?auto=format&fit=crop&q=80&w=1024',
    tags: ["Veggie", "Popular"],
  },
  {
    id: "b5",
    ...
    price: "$9.800",
    category: "Salados",
    image: 'https://images.unsplash.com/photo-1541014741259-de529411b96a?auto=format&fit=crop&q=80&w=1024',
  ...
  },
  {
    ...
    price: "$5.500",
    category: "Salados",
    image: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?auto=format&fit=crop&q=80&w=1024',
  ...
  },
  {
    ...
    price: "$4.200",
    category: "Salados",
    image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&q=80&w=1024',
  ...
  },
  {
    ...
    price: "$7.800",
    category: "Salados",
    image: 'https://images.unsplash.com/photo-1541592106381-b31e9677c0e5?auto=format&fit=crop&q=80&w=1024',
  ...
  // Dulces
  {
    ...
    price: "$5.200",
    category: "Dulces",
    image: 'https://images.unsplash.com/photo-1606313564200-e75d5e30476c?auto=format&fit=crop&q=80&w=1024',
  ...
  },
  {
    ...
    price: "$5.800",
    category: "Dulces",
    image: 'https://images.unsplash.com/photo-1607478900766-efe13248b125?auto=format&fit=crop&q=80&w=1024',
...
export const lunchItems = [
  // Pastas Rellenas
  {
    ...
    image: 'https://images.unsplash.com/photo-1574484284002-952d92456975?auto=format&fit=crop&q=80&w=1024',
  ...
  },
  {
    ...
    price: "$13.500",
    category: "Pastas Rellenas",
    image: 'https://images.unsplash.com/photo-1473093295043-cdd812d0e601?auto=format&fit=crop&q=80&w=1024',
...
export const storeItems = [
  // Cakes
  {
    ...
    price: "$22.000",
    category: "Tortas",
    image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&q=80&w=1024',
  ...
  },
  {
    ...
    price: "$24.500",
    category: "Tortas",
    image: 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?auto=format&fit=crop&q=80&w=1024',
